...
$string['fsaturday'] = 'Samstag';
$string['fsunday'] = 'Sonntag';
$string['fthursday'] = 'Donnerstag';
$string['ftuesday'] = 'Dienstag';
$string['functiondoesntexist'] = 'Funktion des Aktionsbuttons exisitert nicht.';
$string['fwednesday'] = 'Mittwoch';
