...
$string['fsaturday'] = 'Saturday';
$string['fsunday'] = 'Sunday';
$string['fthursday'] = 'Thursday';
$string['ftuesday'] = 'Tuesday';
$string['functiondoesntexist'] = "Function of action button doesn\'t exist.";
$string['fwednesday'] = 'Wednesday';
